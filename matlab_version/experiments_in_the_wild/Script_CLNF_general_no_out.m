...
shapes_init = experiments.shapes;
clear 'experiments';
    ...
    for s = sigmas
        for t = tikhs
            ...
            for i=1:numel(images)
                ...
                clmParams_inner.regFactor = r;
                clmParams_inner.sigmaMeanShift = s; 
                clmParams_inner.tikhonov_factor = t;
                experiment.params = clmParams_inner;
                clmParams_inner.window_size = [w,w];
