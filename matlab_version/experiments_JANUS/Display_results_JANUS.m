...
plot(error_x, error_y, 'Color', [0,0.447,0.741],'DisplayName', 'CLNF basic', 'LineWidth',line_width);
...
plot(error_x(1:2:end), error_y(1:2:end), 'Color',[0.929,0.694,0.125],'DisplayName', 'CLNF refined ROI', 'LineWidth',line_width);
...
plot(error_x(1:2:end), error_y(1:2:end), 'k','DisplayName', 'CLNF manual ROI multi view', 'LineWidth',line_width);
...
% [error_x, error_y] = cummErrorCurve(clnf_error);
% 
% plot(error_x, error_y, 'r','DisplayName', 'CLNF automatic ROI multi view', 'LineWidth',line_width);

load('results/results_janus_clnf_better_ROI_mv_5.mat');
shapes = experiments.shapes;
...
plot(error_x(1:2:end), error_y(1:2:end), 'r', 'DisplayName', 'CLNF automatic ROI multi view', 'LineWidth',line_width);
...
grid on
title('CS0 error rates','FontSize',40,'FontName','Helvetica');

legend('show', 'Location', 'SouthEast');

print -dpdf results/JANUS_data_res.pdf