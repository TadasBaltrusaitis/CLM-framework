function Vanilla_CLNF_better_bbox_on_validation()
...
for i=1:numel(images)
    ...
    % Correct the widths
    bbox(3) = bbox(3) * 0.7418;
    bbox(4) = bbox(4) * 0.7983;

    % Correct the location
    bbox(1) = bbox(1) + bbox_orig(3)*0.1370;
    bbox(2) = bbox(2) + bbox_orig(4)*0.1513;            
...
%%
output_results = 'results/results_dev_clnf_bbox.mat';
