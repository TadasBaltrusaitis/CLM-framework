...
clnf_error = compute_error_JANUS( experiments.labels(:,:,inds ==0),  shapes(:,:,inds ==0));
...
plot(error_x, error_y, 'k','DisplayName', 'CLNF manual ROI', 'LineWidth',line_width);
...
xlim([0,0.3]);
xlabel('Size normalised shape RMS error for profile','FontName','Helvetica');
...
print -dpdf results/JANUS_data_res_profile.pdf