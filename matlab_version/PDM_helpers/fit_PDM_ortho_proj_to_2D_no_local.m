function [ a, R, T, T3D, error, shapeOrtho ] = fit_PDM_ortho_proj_to_2D_no_local( M, shape2D, f, cx, cy)
...
%   Detailed explanation goes here
    ...
    for i=1:1000
        ...
        % get the Jacobians
        J = CalcRigidJacobian(M, p_global);
        
        % RLMS style update
        p_delta = (J'*J + regularisations) \ (J'*error_res(:) - regularisations*p_global);
                                
        [p_global] = CalcReferenceUpdate(p_delta, p_global);
